    ...
    <div class="row">
        <div class="small-12 columns text-center">
            ...
            <ul class="small-block-grid-1 medium-block-grid-5">
                ...
                <li><a href="http://www.nsd.uib.no/nsd/english/index.html" title="Norwegian Center for Research Data (NSD)"><img src="{{ asset("/images/content/partners/nsd_logo.png") }}" alt="Norwegian Social Science Data Services (NSD)" /></a></li>
