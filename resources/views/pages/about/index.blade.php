...
@section("content")
    ...
    <div class="row">
        <div class="small-12 medium-7 columns">
            ...
            <p>Our objective was to develop common practices for storing and disseminating health-related data across national borders, taking advantage of synergies between the Nordic countries. The project built a portal prototype for Nordic health data for research purpose and enhance the visibility of Nordic research in a European context. The work was also laying the ground for further collaboration in finding solutions to common challenges and possibilities with regard to data curation, preservation and data sharing in the Nordic countries.</p>

            <p>For more information, please contact the project leader <a href="http://www.uib.no/personer/Dag.Kiberg" title="University of Bergen: Dag Kiberg">Dag Kiberg</a> of the <a href="http://www.nsd.uib.no/nsd/english/index.html" title="Norwegian Center for Research Data (NSD)">Norwegian Center for Research Data (NSD)</a>.</p>
        </div>
        ...
        <aside class="small-12 medium-5 columns">
            ...
            <ul class="timeline">
                <li class="history">Autumn 2016 in Bergen: Closing meeting</li>
                <li class="history">March 2016 in Gothenburg: 2nd hackathon and 5th meeting</li>
